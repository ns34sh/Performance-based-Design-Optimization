...
gradeLong=['HYSD' num2str(415+85*(x(noOfColProp+noOfBeamProp+noOfWlProp+4)-1))];
% gradeConf=eval(['C' num2str(x(i)) '.GradeConf']);
gradeConf=['HYSD' num2str(415+85*(x(noOfColProp+noOfBeamProp+noOfWlProp+4)-1))];
...
MatRebar=['HYSD' num2str(415+85*(x(noOfColProp+noOfBeamProp+noOfWlProp+4)-1))];
